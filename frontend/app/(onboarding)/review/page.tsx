    ...
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="flex items-center justify-between mt-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="/select-agents" className="inline-flex items-center gap-2 h-11 px-8 rounded-lg bg-[#534AB7] text-white font-semibold text-sm hover:bg-[#433AA0] transition shadow-sm">
            Looks good, continue
