          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
            {messages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                {msg.role === "aria" && (
                  <img src="/logo.webp" alt="ARIA" className="w-8 h-8 rounded-full object-cover flex-shrink-0 mr-3 mt-0.5" />
                )}
                <div>
            ...
            {loading && (
              <div className="flex justify-start">
                <img src="/logo.webp" alt="ARIA" className="w-8 h-8 rounded-full object-cover flex-shrink-0 mr-3" />
