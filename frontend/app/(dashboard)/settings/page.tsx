      ...
      {activeTab === "Integrations" && (
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-[#E0DED8]">
            <div className="px-5 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-[#E8F5E8] flex items-center justify-center">
              ...
              {whatsappConnected === false ? (
                <button
                  ...
                  className="text-xs font-medium px-4 py-2 rounded-lg bg-[#25D366] text-white hover:bg-[#1da851] transition-colors"
                >
                  Connect WhatsApp
                </button>
              ) : whatsappConnected ? (
