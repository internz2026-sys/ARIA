  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative p-2 rounded-lg text-[#5F5E5A] hover:bg-[#F8F8F6] hover:text-[#2C2C2A] transition-colors"
        title="Notifications"
      >
        ...
        {count > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center bg-[#D85A30] text-white text-[10px] font-bold rounded-full px-1">
            {displayCount}
          </span>
        )}
      </button>
